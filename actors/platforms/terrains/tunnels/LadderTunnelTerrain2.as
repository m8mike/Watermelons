package  {
	 ...
	 * @author Mad Mike
	 */
	public class LadderTunnelTerrain2 extends Terrain {
		
		public function LadderTunnelTerrain2(location:Point, numPatterns:int) {
			...
			for (var j:int = 1; j < numPatterns; j++) {
				...
				platform = new Standard(j * 500 / 20 + location.x, location.y-12, Math.sqrt(8), 2);
				platform.setAngle(45);
				addPlatformCostume(j * 500 / 20 + location.x, location.y-12, Math.sqrt(8), 2, 45);
				new Standard(j * 500 / 20 + 2 + location.x, location.y - 2, 210 / 20, 2);
				addPlatformCostume(j * 500 / 20 + 2 + location.x, location.y - 2, 210 / 20, 2);
				new Standard(j * 500 / 20 + 2 + location.x, location.y - 10, 210 / 20, 2);
				addPlatformCostume(j * 500 / 20 + 2 + location.x, location.y - 10, 210 / 20, 2);
				...
				platform = new Standard(j * 500 / 20 + 250 / 20 + location.x, location.y - 10, Math.sqrt(8), 2);
				platform.setAngle( -45);
				addPlatformCostume(j * 500 / 20 + 250 / 20 + location.x, location.y - 10, Math.sqrt(8), 2, -45);
				...
				new Standard(j * 500 / 20 + 250 / 20 + 2 + location.x, location.y-12, 210 / 20, 2);
				addPlatformCostume(j * 500 / 20 + 250 / 20 + 2 + location.x, location.y-12, 210 / 20, 2);
			}
