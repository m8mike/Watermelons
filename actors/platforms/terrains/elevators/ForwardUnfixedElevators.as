package {
	 ...
	 * @author Mad Mike
	 */
	public class ForwardUnfixedElevators extends Terrain {
		
		public function ForwardUnfixedElevators(location:Point, numElevators:int) {
			...
			for (var i:int = 0; i < numElevators; i++) {
				...
				new StandardUnfixedMoving(location.x + offset, location.y + 2, 
										new Point(location.x + offset, location.y - 10), 10, 2, true);
				offset += 10;
			}
